...
import com.chefapp.activities.RecipeDetailActivity;
...
public class FotosFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter.setOnRecipeClickListener((recipe, position) -> {
            Intent intent = new Intent(getContext(), RecipeDetailActivity.class);
            intent.putExtra(RecipeDetailActivity.EXTRA_RECIPE_NAME,   recipe.getName());
            intent.putExtra(RecipeDetailActivity.EXTRA_RECIPE_INFO,   recipe.getInfoLine());
